...
- User can assign a category to a recipe
- User can search for recipes based on a category, ingredient or keywords
- The program can randomly select a recipe for the user to cook
